            ...
            {options.length > 0 &&
                ...
                <div className="flex flex-col gap-3" ref={wrapperRef}>
                    ...
                    `}
                        ...
                        {open && (
                            <div
                                className="fixed w-full z-50 flex items-center justify-center sm:absolute max-sm:h-screen max-sm:top-1/2 max-sm:left-1/2 max-sm:-translate-1/2 max-sm:backdrop-blur-[2px] max-sm:bg-[rgba(84,91,106,0.50)] sm:top-full sm:left-0"
                                onClick={() => setOpen(false)}
                            >
                                <ul
                                    className="w-full max-sm:w-90/100 space-y-0.5 p-1 bg-white rounded-2xl shadow-sm z-2"
