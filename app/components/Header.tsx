...
//             <Link
//               href="/"
//               className={`px-6 py-3 rounded-xl text-sm font-medium transition ${buttonVariant}`}
//             >
//               Get Early Access
//             </Link>
//           </div>
...
//                 <Link
//                   href="/"
//                   className={`px-6 py-3 block text-center rounded-xl text-sm font-medium transition ${buttonVariant}`}
//                 >
//                   Get Early Access
//                 </Link>
//               </div>
