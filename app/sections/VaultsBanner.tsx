        ...
        <div className="max-xs:pt-30 max-xs:pb-12 max-sm:pb-24 pt-46 pb-42 bg-gray900 relative">
            <div className="container max-sm:p-0">
                <div className="sm:text-center">
                    ...
                    <div className="max-sm:px-4 mt-8">
                    ...
                    <div className="max-sm:px-4 mt-8 w-full max-w-230 mx-auto">
                        ...
                        <div className='grid grid-cols-12 gap-2'>
                            {data.map((item, index) => (
                                <div key={index} className='col-span-12 md:col-span-4'>
                                    <div className='h-full max-xs:gap-5 sm:text-left max-xs:p-5 max-sm:gap-4 max-sm:py-10 max-sm:px-4 flex flex-col items-start gap-4 xl:gap-4 rounded-3xl p-6 xl:p-10 bg-gray800'>
                    ...
                    <div className='max-sm:px-4 relative z-10 mt-12 md:mt-18 max-sm:flex-col max-sm:items-start flex gap-4 justify-center'>
