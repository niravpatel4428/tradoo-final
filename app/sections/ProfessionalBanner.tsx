...
const ProfessionalBanner: React.FC = () => {
    ...
    return (
        <div className="max-xs:pt-30 max-xs:pb-12 pt-46 pb-42 bg-gray900 relative">
            <div className="container">
                <div className="sm:text-center">
                        ...
                        <div className='grid grid-cols-12 gap-2'>
                            {data.map((item, index) => (
                                <div key={index} className='col-span-4'>
                                    <div className='h-full flex items-center gap-8 rounded-3xl p-10 bg-gray800'>
                    ...
                    <div className='relative z-10 mt-18 max-sm:flex-col max-sm:items-start flex gap-4 justify-center'>
