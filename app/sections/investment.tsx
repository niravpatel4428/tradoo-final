        ...
        <div className="container">
          <div>
            ...
            <div className="mt-12 w-full max-w-171">
              <p className="text-gray700 text-lg font-normal leading-[144%]">
            ...
            <div className="grid grid-cols-12 gap-2">
              {features.map((item, index) => (
                <div key={index} className="col-span-12 md:col-span-6 lg:col-span-4">
                  <div className="h-full rounded-3xl bg-gray100 p-5 xxl:p-8 flex gap-6 items-center">
                    <div className="rounded-xl w-16 h-16 min-w-16 flex justify-center items-center bg-white p-3">
                      <Image src={item.icon} alt={item.alt} />
                    </div>
                    <div className="flex flex-col gap-2">
                      <span className="text-lg font-semibold leading-6 text-gray800">
                        {item.title}
                      </span>
                      <span className="text-lg font-normal leading-6 text-gray700">
                        {item.desc}
                      </span>
                    </div>
                  </div>
