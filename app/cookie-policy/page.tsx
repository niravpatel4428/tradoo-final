                                    ...
                                    <div className="bg-gray100 border border-gray300 rounded-xl p-6 md:p-8">
                                        <div className="flex gap-3">
                                            <span className="mt-0.5">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-shield h-5 w-5 text-primary mt-0.5 shrink-0"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path></svg>
                                            </span>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="bg-gray100 border border-gray300 rounded-xl p-6 md:p-8">
                                        ...
                                        <div className="space-y-3 text-gray700 leading-relaxed">
                                            <ul className='space-y-3'>
                                                <li className='flex items-center gap-3'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-circle-help h-5 w-5 text-muted-foreground shrink-0 mt-0.5"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><path d="M12 17h.01"></path></svg>
